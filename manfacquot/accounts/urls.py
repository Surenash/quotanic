...
from .manufacturer_settings_views import ManufacturerSettingsView, ManufacturerSettingsResetView
...
manufacturer_urlpatterns = [
    ...
    # Settings APIs
    path('settings/', ManufacturerSettingsView.as_view(), name='manufacturer_settings'), # GET, PUT /api/manufacturers/settings/
    path('settings/reset/', ManufacturerSettingsResetView.as_view(), name='manufacturer_settings_reset'), # POST /api/manufacturers/settings/reset/
    
    # Dashboard APIs
    path('dashboard/stats/', views.ManufacturerDashboardStatsView.as_view(), name='manufacturer_dashboard_stats'), # GET /api/manufacturers/dashboard/stats/
    path('dashboard/recent-activity/', views.ManufacturerRecentActivityView.as_view(), name='manufacturer_recent_activity'), # GET /api/manufacturers/dashboard/recent-activity/
