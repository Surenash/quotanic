...
urlpatterns = [
    ...
    # ===================================================================
    # FBM-Specific Endpoints
    # ===================================================================
    
    # GET /api/designs/<uuid:id>/fbm-analysis/ - Complete FBM analysis data
    path('<uuid:id>/fbm-analysis/', views.FBMAnalysisView.as_view(), name='fbm_analysis'),
    
    # GET /api/designs/<uuid:id>/fbm-features/ - Detected features
    path('<uuid:id>/fbm-features/', views.FBMFeaturesView.as_view(), name='fbm_features'),
    
    # GET /api/designs/<uuid:id>/fbm-operations/ - Machining operations
    path('<uuid:id>/fbm-operations/', views.FBMOperationsView.as_view(), name='fbm_operations'),
    
    # GET /api/designs/<uuid:id>/fbm-patterns/ - Recognized patterns
    path('<uuid:id>/fbm-patterns/', views.FBMPatternsView.as_view(), name='fbm_patterns'),
    
    # GET /api/designs/<uuid:id>/fbm-export/ - Export operation sheet
    path('<uuid:id>/fbm-export/', views.FBMExportView.as_view(), name='fbm_export'),
    
    # GET /api/designs/<uuid:id>/fbm-intelligence/ - Comprehensive manufacturing intelligence
    path('<uuid:id>/fbm-intelligence/', views.FBMManufacturingIntelligenceView.as_view(), name='fbm_intelligence'),
]
