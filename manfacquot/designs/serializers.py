...
class DesignCreateSerializer(serializers.ModelSerializer):
    ...
    The client provides s3Key, designName, material, quantity, and manufacturing metadata.
...
class FBMAnalysisSerializer(serializers.Serializer):
    ...
    bbox_mm = serializers.ListField(child=serializers.FloatField(), required=False)
    surface_area_cm2 = serializers.FloatField(required=False)
    complexity_score = serializers.FloatField(required=False)
    analysis_engine = serializers.CharField(required=False)
    ...
    fbm_geometry_analysis = serializers.DictField(required=False)
    ...
    manufacturing_intelligence = serializers.DictField(required=False)
